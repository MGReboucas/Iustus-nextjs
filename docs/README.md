...
> Revisão 1.3 · Levantamento: 16/09/2026 · Responsável técnico: desenvolvedor único. Estrutura frontend/backend/infra/docs criada; validação das regras operacionais e contratuais ainda pendente.
